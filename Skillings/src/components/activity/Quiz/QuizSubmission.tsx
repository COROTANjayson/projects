...
const QuizSubmission: React.FC<Props> = ({ activityId }) => {
            ...
            render: (row) => (
                <>
                    <div style={{ backgroundColor: "#F5F7FA", height: "46px", display: " flex", justifyContent: "center", alignItems: "center" }}>
                        ...
                        <Text style={{ display: "block" }}>data draft</Text>
            ...
            render: (row) => (
                <>
                    <Button style={{ border: "none", backgroundColor: "#F5F7FA", width: "100%", height: "46px", margin: "4px", display: "flex", justifyContent: "center", alignItems: "center" }}>
                        <Link href={`/tutor/${user.uid}/activity/submission/check/${row.activityId}?studentId=${row.userData.id}`}>{row.graded ? "Re-check" : "Check"}</Link>
                    </Button>
                </>
            )
        }
